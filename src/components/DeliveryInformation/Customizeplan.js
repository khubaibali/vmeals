            ...
            <div className="grid grid-cols-10  lg:gap-4  border-2 border-green   rounded-full bg-white shadow-lg ">
                  ...
                  <div className="relative">
                    <button class=" text-smtwo md:text-xstwo lg:text-xsone xl:text-smtwo 2xl:text-base f-f-r text-black  rounded-full    px-[32px] md:px-[25px] addwidth py-[3px] lg:py-[6px] 2xl:px-[49px] 2xl:h-[74px]">
                      <ul className="inline-flex">
                        ...
                        <li className="mt-1 md:mt-2.5 lg:mt-3 ml-2 lg:ml-4">
                          Customise Plan
                        </li>
                      </ul>
                    </button>
              ...
              <div className="   col-span-2 md:col-span-2 xl:col-span-2  ">
                <div className="relative">
                  ...
                  <img
                    src="/images/arrowplans.png"
                    className="  w-[36px] xl:w-[60px] absolute top-[50%] right-[4px] md:right-[10px]  lg:right-[14px] xl:right-[1px] 2xl:right-[5px] "
                  />
                </div>
              </div>
              <div className="   col-span-2 md:col-span-2 xl:col-span-2  ">
                <div className="relative">
                  <Link href="/deliveryInformation">
                    <button class=" text-smtwo md:text-xstwo  sub lg:text-xsone xl:text-smtwo 2xl:text-base f-f-r text-white  rounded-full    px-[20px] md:px-[12px] addwidth pb-[3px] md:py-[3px] lg:py-[6px] 2xl:px-[25px] 2xl:h-[74px]">
                      <ul className="inline-flex">
                        <li>
                          <img
