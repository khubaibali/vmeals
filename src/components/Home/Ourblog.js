    ...
    <div className="our-blog-home-bg">
      <div className="py-10 2xl:py-20">
        <div className=" w-11/12 2xl:max-w-[1600px] ml-auto mr-auto">
          <p className="  text-base text-center  sm:text-3xl 2xl:text-4xl f-f-li  md:mt-10 text-green tracking-[1px] lg:tracking-[0.22em] ">
            OUR BLOG
          </p>
            ...
            {/* <div className="   col-span-6 lg:col-span-4  ">
              <div className="relative ">
                ...
                <div className="blog-liner p-2 md:py-5 md:p-5  absolute bottom-0">
                  <p className=" text-white f-f-r text-xs md:text-base 2xl:text-xl md:py-4 2xl:py-8 ">
                    28th September, 2022
                  </p>
