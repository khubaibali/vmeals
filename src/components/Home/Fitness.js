    ...
    <div className=" w-11/12 2xl:max-w-[1600px] ml-auto mr-auto  my-10 md:my-20">
      <div className="grid grid-cols-12 gap-4 sm:gap-8 lg:gap-14  ">
        <div className="   col-span-12 lg:col-span-6  ">
          <p className="  text-base text-center lg:text-left sm:text-3xl 2xl:text-4xl f-f-li uppercase  md:mt-10 text-green tracking-[1px] lg:tracking-[0.22em] ">
            {/* GET STARTED */}
            {homeFitnessData[0]?.VMealsGetStartedHeading}
          </p>
          <p className=" text-center lg:text-left text-xl sm:text-5xl 2xl:text-7xl f-f-b black md:leading-[50px] 2xl:leading-[75px] mt-4  md:mt-8">
...

          {
            homeFitnessData[0]?.VMealsGetStartedList.map((dt,ind) => (
              <ul className="inline-flex">
                <li>
                  <p className="f-f-b text-green text-6xl sm:text-8xl 2xl:text-10xl mt-16 2xl:mt-8">
                  0{ind+1}.
                  </p>
                </li>
                <li className="ml-4">
                  <p className="  mt-4 md:mt-0 text-base sm:text-xl xl:text-2xl leading-[31px] 2xl:leading-[46px] 2xl:text-4xl text-black  sm:pt-10 f-f-b  ">
                    {/* Choose your plan */}
                    {dt?.VMealsGetStartedItemTitle}
                  </p>
                  <p className="   f-f-r text-black text-tiny  2xl:text-base mt-2 md:mt-5 leading-[23px] ">
