          ...
          <div className="grid grid-cols-12  gap-8  ">
            <div className="   col-span-12 lg:col-span-4  ">
              <div className=" shadow-lg w-7/12   lg:w-full ml-auto mr-auto liner md:w-6/12  h-[205px]  sm:h-[400px] 2xl:h-[539px] px-3 md:px-8 rounded-[20px] ">
                <h2 className="  text-center text-tiny md:text-2xl 2xl:text-4xl f-f-li text-white pt-10 sm:pt-36 2xl:pt-44">
                  {/* BUILT FOR YOU */}
                  {builtData[0]?.VMealsCustomersChooseUsTitle}
                </h2>
                <h2 className=" f-f-b text-center text-base sm:text-2xl  md:text-2xl xl:text-3xl leading-[23px] sm:leading-[31px] xl:leading-[46px] 2xl:text-6xl text-white pt-5 2xl:pt-10 ">
