        ...
        <div className="grid grid-cols-12  mt-10 md:my-10 2xl:my-20   bg-green-light rounded-[100px] ">
          ...
          <div className="   col-span-12 hidden md:block  xl:col-span-6  ">
            <div className=" relative ">
              ...
              />
              <div className=" 2xl:w-[518px] w-[356px] h-[319px] md:w-[441px] md:h-[371px] 2xl:h-[371px] personscrd p-6 md:p-8 left-[4%] md:left-[19%] lg:left-[9%] xl:left-[19%] bottom-[49px] md:bottom-[110px] xl:bottom-[49px] absolute">
