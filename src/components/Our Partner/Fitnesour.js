    ...
    <div className=" w-11/12 2xl:max-w-[1600px] ml-auto mr-auto mb-3 mt-10 sm:my-20">
      <div className="grid grid-cols-12  gap-8 lg:gap-14  ">
        <div className="   col-span-12 lg:col-span-5 xl:col-span-5  ">
          ...
          <h2 className="  text-base  sm:text-3xl 2xl:text-4xl f-f-li text-green text-center xl:text-left tracking-[1px] lg:tracking-[0.22em] ">
            {/* OUR PARTNERS */}
            {ourParnersData?.[0]?.VMealsOurPartnersTitle}
          </h2>
          {<OurSlickWraper description={ourParnersData[0]?.VMealsOurPartnersList[0]?.VMealsOurPartnersDescription} data={ourParnersData[0]?.VMealsOurPartnersList} setPartnerListIndex={setPartnerListIndex}/>}
          </div>
        </div>
