          ...
          <div className="   col-span-12  xl:col-span-4 hidden xl:block ">
            ...
            <div className="cardurdu w-[374px] h-[257px] 2xl:w-[450px] 2xl:h-[300px] relative ml-auto mr-auto ">
              <div className="text-right w-6/12 ml-auto pr-4 pt-8 ">
                <p className="f-f-b text-green text-base 2xl:text-2xl   ">
                  بحاجة الى مساعدة في اختيار خطة؟
                </p>
                <p className=" f-f-li text-black text-tiny 2xl:text-base   ">
            ...
            <div className="cardurdu w-[374px] h-[257px] 2xl:w-[450px] 2xl:h-[300px] relative mt-10 ml-auto mr-auto ">
              <div className="text-left w-8/12 mr-auto pl-4 pt-4 ">
                <p className="f-f-b text-green text-base 2xl:text-3xl 2xl:leading-[41px]   ">
                  Need help in choosing a plan?
                </p>
                <p className=" f-f-r text-black-light text-tiny 2xl:text-base  mt-4 ">
              ...
              <div className="  col-span-12  md:col-span-6  lg:col-span-4  ">
                <Link href="/classic-diet">
                  <div className="cardurdu testtingcard classic  relative p-6 ">
                    <p className="f-f-b text-2xl 2xl:text-4xl text-sky  ">
                      {" "}
                      Classic Diet
                    </p>
              ...
              <div className="  col-span-12  md:col-span-6  lg:col-span-4  ">
                <Link href="/green-diet">
                  <div className="greencard testtingcard  Green relative p-6 ">
                    <p className="f-f-b text-2xl 2xl:text-4xl text-green  ">
                      {" "}
                      Green Diet
                    </p>
              ...
              <div className="  col-span-12  md:col-span-6  lg:col-span-4  ">
                <Link href="/gluten-dairy-free-diet-plan">
                  <div className="cardgluent testtingcard Gluten  relative p-6 ">
                    <p className="f-f-b text-2xl 2xl:text-4xl text-pink 2xl:leading-[47px] ">
                      {" "}
                      Gluten & Dairy <br />
                      Free Diet
                    </p>
              ...
              <div className="  col-span-12  md:col-span-6  lg:col-span-4  ">
                <Link href="/indian-fusion-meal-plan">
                  <div className="indiancard testtingcard  Indian relative p-6 ">
                    <p className="f-f-b text-2xl 2xl:text-4xl text-brownn 2xl:leading-[47px] ">
                      {" "}
                      Indian Fusion <br />
                      Diet
                    </p>
              ...
              <div className="  col-span-12  md:col-span-6  lg:col-span-4  ">
                <Link href="/pescatarian-diet-plan">
                  <div className="cardpestarn testtingcard Pescatarian  relative p-6 ">
                    <p className="f-f-b text-2xl 2xl:text-4xl text-pink-dark 2xl:leading-[47px] ">
                      {" "}
                      Pescatarian
                      <br />
                      Diet
              ...
              <div className="  col-span-12  md:col-span-6  lg:col-span-4  ">
                <Link href="/keto-diet-plan">
                  <div className="ketotarn testtingcard Keto  relative p-6 ">
                    <p className="f-f-b text-2xl 2xl:text-4xl text-red-dark 2xl:leading-[47px] ">
                      {" "}
                      Keto Diet
                    </p>
...
<div className="cardurdu w-[374px] md:w-[100%] lg:w-[374px]  h-[257px] 2xl:w-[450px] 2xl:h-[300px] relative mt-2 md:mt-10 ml-auto mr-auto ">
  <div className="text-left w-8/12 mr-auto pl-4 pt-4 ">
    <p className="f-f-b text-green text-xl md:text-base leading-[29px] 2xl:text-3xl 2xl:leading-[41px]   ">
      Need help in choosing a plan?
    </p>
    <p className=" f-f-r text-black-light text-tiny 2xl:text-base   ">
      Get in touch with our nutritionist and let the experts decide
      what is best for you!
    </p>
