                ...
                <div className=" planscrol ">
                    <div className={`grid grid-cols-10  lg:gap-4  border-2 border-green   rounded-full bg-white shadow-lg `}>
                            ...
                            <div className="relative">
                                <div className="text-left" >
                                    <Link href="/meal-plans">
                                        <button className={`    ${step == 0 ? '  size-steps f-f-b text-white green-gradiant-2 rounded-full px-[32px] md:px-[25px] addwidth py-[10px] md:py-[3px] lg:py-[6px] 2xl:px-[49px] 2xl:h-[74px]  ' : 'text-black  px-[32px] md:px-[25px] addwidth py-[10px] md:py-[3px] lg:py-[6px] 2xl:px-[49px] 2xl:h-[74px] '} rounded-full   size-steps f-f-r  `}>
                        ...
                        <div className="   col-span-2 md:col-span-2 xl:col-span-2  ">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`  size-steps f-f-r  ${step == 1 ? ' text-smtwo md:text-xstwo green-gradiant-2 lg:text-xsone xl:text-smtwo 2xl:text-base f-f-b text-white rounded-full px-[15px] md:px-[25px] addwidth py-[10px] md:py-[3px] lg:py-[6px] 2xl:px-[30px] 2xl:h-[74px] ' : 'px-[32px] md:px-[25px] addwidth py-[10px] md:py-[3px] lg:py-[6px]  2xl:h-[74px]  text-black '}  rounded-full    `}>
                                    <ul className="inline-flex">
                                        <li>
                                            <img
                        ...
                        <div className="   col-span-2 md:col-span-2 xl:col-span-2  ">
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className={` ${step == 2 ? 'green-gradiant-2   text-white  f-f-b 2xl:px-[20px]  md:px-[18px]   px-[13px]  addwidth py-[10px] md:py-[3px] lg:py-[6px]  2xl:h-[74px]' : 'text-black 2xl:px-[49px] md:px-[25px]  px-[32px]  addwidth py-[10px] md:py-[3px] lg:py-[6px]  2xl:h-[74px]'}  size-steps f-f-r  rounded-full   `}>
                                    <ul className="inline-flex">
                                        <li>
                                            <img
                        ...
                        <div className="   col-span-2 md:col-span-2 xl:col-span-2  ">
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className={` ${step == 3 ? 'green-gradiant-2   text-white f-f-b px-[15px] md:px-[9px] xl:px-[17px] addwidth py-[10px] md:py-[3px] lg:py-[6px] 2xl:px-[21px]  lg:ml-[14px] xl:ml-0 2xl:ml-[14px] 2xl:h-[74px] ' : 'text-black px-[32px] md:px-[25px] addwidth py-[10px] md:py-[3px] lg:py-[6px] 2xl:px-[49px] 2xl:h-[74px] '}  size-steps f-f-r   rounded-full    `}>
                                    <ul className="inline-flex">
                                        <li>
                                            <img
                        ...
                        <div className="   col-span-2 md:col-span-2 xl:col-span-2  ">
                            ...
                            <button className={` ${step == 4 ? 'green-gradiant-2   text-white f-f-b  px-[37px] md:px-[29px] lg:px-[47px] xl:px-[38px] addwidth py-[10px] md:py-[3px] lg:py-[6px] 2xl:px-[45px] 2xl:h-[74px] ' : 'text-black   px-[32px] md:px-[25px] addwidth py-[10px] md:py-[3px] lg:py-[6px] 2xl:px-[49px] 2xl:h-[74px] '}  size-steps f-f-r   rounded-full ml-[16px] `}>
                                <ul className="inline-flex">
                                    <li>
                                        <img
