    ...
    <div className=" w-11/12 2xl:max-w-[1600px] ml-auto mr-auto my-10 sm:my-20">
      <div className="grid grid-cols-12  gap-8 lg:gap-14  ">
        <div className="   col-span-12 xl:col-span-6  ">
          <p className="  text-base  sm:text-3xl 2xl:text-4xl f-f-li  mt-10 text-green text-center xl:text-left tracking-[1px] lg:tracking-[0.22em] ">
            ABOUT OUR COMPANY
          </p>
          <p className=" text-center xl:text-left text-xl sm:text-5xl 2xl:text-7xl f-f-b black md:leading-[50px] 2xl:leading-[75px]  mt-8">
