...
export default function Customizeplan({
  ...
  const mapPlanName = (plan) => {
    ...
    if (plan == "GlutenAndDairyFreeDiet") return "Gluten & Dairy Free Diet";
    if (plan == "KetoDiet") return "Keto Diet";
    if (plan == "PescatarianDiet") return "Pescatarian Diet";
    else return plan;
  };
            ...
            <div className="   col-span-12  lg:col-span-6  ">
              <div className="bg-green-light p-4 md:p-8 rounded-[20px]  ">
                <ul className="inline-flex w-full ">
                  <li>
                    <h3 className=" text-green f-f-b text-center md:text-left text-base mt-3  md:text-3xl lg:text-lg  2xl:text-5xl md:mt-5  ">
                      Customise your plan
                    </h3>
                  </li>
