...
export default function Whtsapps() {
  ...
  return (
    <div>
      <a href='https://wa.me/+971562922081' target={"_blank"} className="fixed right-5 top-[25%] cursor-pointer z-[9999] ">
        <img alt=""
      ...
      {showBtn &&
        <button className="fixed right-5 bottom-[30%] cursor-pointer z-[9999]" onClick={() => moveup()}>
          <img alt=""
