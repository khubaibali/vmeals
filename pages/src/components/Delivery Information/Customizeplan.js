              ...
              <div className="   col-span-2 md:col-span-2 xl:col-span-2  ">
                <div className="relative">
                  <Link href="/deliveryInformation">
                    <button class=" text-smtwo md:text-xstwo  sub lg:text-xsone xl:text-smtwo 2xl:text-base f-f-r text-white  rounded-full    px-[32px] md:px-[12px] addwidth pb-[3px] lg:py-[6px] 2xl:px-[25px] 2xl:py-[20px]">
                      <ul className="inline-flex">
                        <li>
                          <img
                            src="/images/delivery-icon-active 1.png"
                            className="  w-[16px] md:w-[14px] lg:w-[16px] xl:w-[25px] h-auto mt-2 2xl:mt-3  "
                          />
                        </li>
