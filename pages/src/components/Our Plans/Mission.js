...
export default function Mission() {
  return (
    <div className="  w-11/12 md:w-10/12 lg:w-7/12 xl:w-11/12 2xl:max-w-[1600px] ml-auto mr-auto my-10 sm:my-20">
            ...
            <div className="absolute top-[31%] w-[95%] right-0 left-0">
              <div className="text-center w-10/12 ml-auto mr-auto    ">
                ...
                <h1 className="f-f-li text-black   text-xstwo md:text-smtwo 2xl:text-sm my-2 2xl:my-4 ">
                  ...
                  working long hours, having a family or just simply wanting
                  convenience. VMeals are dedicated to helping people stay
