          ...
          <div className="   col-span-12  xl:col-span-4 hidden xl:block ">
            ...
            <div className="cardurdu w-[374px] h-[257px] 2xl:w-[450px] 2xl:h-[300px] relative ml-auto mr-auto ">
              <div className="text-right w-6/12 ml-auto pr-4 pt-8 ">
                ...
                <a href="/contact-us" style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}} class=" text-center text-sm sm:text-tiny 2xl:text-lg f-f-b text-white sub rounded-full w-[180px] 2xl:w-[221px] sm:px-[29px] h-[50px] sm:py-[14px] 2xl:px-[63px] 2xl:h-[74px] mt-5 2xl:mt-8  absolute right-[17px] bottom-[21px] ">
                  احجز موعدك
                </a>
                <img
            ...
            <div className="cardurdu w-[374px] h-[257px] 2xl:w-[450px] 2xl:h-[300px] relative mt-10 ml-auto mr-auto ">
              <div className="text-left w-8/12 mr-auto pl-4 pt-4 ">
                ...
                <a href="/contact-us" style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}} class=" text-sm sm:text-tiny 2xl:text-lg f-f-b text-white sub rounded-full  2xl:w-[219px] w-[173px] h-[55px] 2xl:h-[61px] mt-5 2xl:mt-8  absolute left-[17px] bottom-[21px] 2xl:bottom-[21px] text-center align-middle  ">
                  Book Appointment
                </a>
                <img
